 ...
 * @param firstRun Is this the first time the plugin is run? Used for saving default configuration files.
 * @param locale The plugin's locale.
 * @param aliases The {@link List} of {@link Alias} to register commands with.
 */
@ConfigSerializable
public record Settings(int version, boolean firstRun, @Nullable String locale, @NotNull List<Alias> aliases) {
    /**
