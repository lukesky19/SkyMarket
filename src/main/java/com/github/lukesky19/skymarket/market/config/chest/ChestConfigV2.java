...
/**
 * This record contains the configuration for the version 2 format of the chest market configuration.
 * @apiNote For migration purposes only. Some data has been removed from here that is no longer used.
...
public record ChestConfigV2(
     ...
     * @param transactionItem The {@link ItemStackConfig} for the transaction item.
