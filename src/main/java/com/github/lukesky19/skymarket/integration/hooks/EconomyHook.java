...
public class EconomyHook implements Hook {
     ...
     */
    public EconomyHook(@NotNull SkyMarket skyMarket) {
    ...
    public void initialize() {
        if(skyMarket.getServer().getPluginManager().isPluginEnabled("Vault")) {
            RegisteredServiceProvider<Economy> rsp = skyMarket.getServer().getServicesManager().getRegistration(Economy.class);
            if (rsp != null) {
